...
# user_cls_list = [None] * 4539861
# user_cls_iter = izip(open("svd_uid.input"), open("k_X.csv"))
# while True:
#     id_, row = next(user_cls_iter, (None, None))
#     if row is None:
#         break
#     user_cls_list[int(id_)] = int(float(row))
# def get_user_cls(uid):
#     return user_cls_list[uid - 1]
